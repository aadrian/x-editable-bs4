$(function(){
    ...
    $.mockjax({
        ...
        urlParams: ["search"],
        response: function(settings) {
            const countries = getCountryList(settings.data.search);
            this.responseText = {
                results: countries
            };
            log(settings, this);
