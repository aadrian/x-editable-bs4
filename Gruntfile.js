    ...
    var config = {
        bootstrap: {
            ...
            inputs: [
                ...
                inputs+'date/bootstrap-datepicker/locales/bootstrap-datepicker.de.min.js',
                inputs+'date/bootstrap-datepicker/locales/bootstrap-datepicker.es.min.js',
                inputs+'date/bootstrap-datepicker/locales/bootstrap-datepicker.fr.min.js',
                inputs+'date/bootstrap-datepicker/locales/bootstrap-datepicker.it.min.js',
                inputs+'date/bootstrap-datepicker/locales/bootstrap-datepicker.en-GB.min.js',
                inputs+'date/date.js', 
